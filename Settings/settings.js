var settings = {
  ...
  "CheckLevelInvalidResponse": "{0} does not have a valid data file",
  ...
  "EquipmentWhisperResponse": "{0} has the following equipped: (head) {1}, (body) {2}, (hands) {3}, (legs) {4}, (feet) {5}, (right hand) {6}, (left hand) {7}, (back) {8}",
  "EquipmentResponse": "{0} check your twitch inbox for your equipment info, you may need to refresh.",
  "EquipmentCooldownResponse": "{0} the equipment command is on cooldown for {1} seconds",
  "EquipmentInvalidResponse": "{0} does not have a valid data file",
  "EquipmentWhisperCooldown": 1.0,
  "EquipmentChatCooldown": 10,
